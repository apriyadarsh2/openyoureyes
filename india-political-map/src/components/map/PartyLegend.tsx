  ...
  return (
    <div className="bg-politic-card rounded-2xl border border-white/10 p-4 shadow-sm">
      <div className="flex items-center justify-between mb-3">
        <h3 className="text-[11px] font-bold text-politic-muted uppercase tracking-widest">
          State Control Overview
        </h3>
        <span className="text-[10px] font-semibold text-politic-muted bg-politic-card-dark px-2 py-0.5 rounded border border-white/10">
      ...
      {totalStates > 0 ? (
        <div className="flex items-center gap-4">
          ...
          <div className="relative flex-shrink-0">
            ...
            <div className="absolute inset-2 bg-politic-card rounded-full flex items-center justify-center">
                ...
                return (
                  <div key={party} className="flex items-center justify-between text-xs">
                    ...
                    <div className="flex items-center gap-1.5 flex-shrink-0">
                      <span className="text-[10px] text-politic-muted font-medium">{percentage}%</span>
                      <span className="text-[10px] font-black text-white bg-politic-card-dark px-1.5 py-0.5 rounded border border-white/10">
                        {count}
                      </span>
                    </div>
                  </div>
        ...
        <div className="text-xs text-politic-muted text-center py-3 font-medium">
