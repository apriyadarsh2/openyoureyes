...
export default function FinancialPage() {
  ...
  const financialDisclosure = politician?.financialDisclosure;
  ...
  return (
    <div className="space-y-8">
      <FinancialSnapshot
        disclosure={financialDisclosure.disclosure}
      />
      ...
      <ImmovableAssetsTable
        disclosure={financialDisclosure.disclosure}
      />

      <FinancialLiabilitiesTable
        disclosure={financialDisclosure.disclosure}
      />
